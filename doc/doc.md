...
TSA has a public deployment model, then all used services such as CodeDeploy or DynamoDB are provided by AWS and are publicly accessible. Furthermore we don't use any private hosted data centers. An important reason for using a public deployment model is the mega scalable infrastructure.
